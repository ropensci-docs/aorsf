# Contributing to aorsf

Want to contribute to `aorsf`? Great! `aorsf` is in an initially stable
state of development, with a great deal of active subsequent development
envisioned. Below is an outline of how to propose a change to `aorsf`.

For more detailed info about contributing to this, and other tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/aorsf", fork = TRUE)`.
...
Please note that the aorsf project is released with a [Contributor Code
of Conduct](https://docs.ropensci.org/aorsf/CODE_OF_CONDUCT.md). By
