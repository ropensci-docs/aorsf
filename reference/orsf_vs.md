...
#>           <int>      <num>                                        <list>
#> 1:           15  0.8264493     age,albumin,ascites,ast,bili,chol,...[14]
#> 2:           16  0.8256680     age,albumin,ascites,ast,bili,chol,...[15]
#> 3:           17  0.8271264     age,albumin,ascites,ast,bili,chol,...[16]
#> 4:           18  0.8296786     age,albumin,ascites,ast,bili,chol,...[17]
#> 5:           19  0.8185322 age,albumin,alk.phos,ascites,ast,bili,...[18]
#>                                         predictors_included predictor_dropped
#>                                                      <list>            <list>
#> 1: age,sex_f,ascites_1,hepato_1,spiders_1,edema_0.5,...[15]                NA
#> 2: age,sex_f,ascites_1,hepato_1,spiders_1,edema_0.5,...[16]          platelet
#> 3:        id,age,sex_f,ascites_1,hepato_1,spiders_1,...[17]                id
#> 4:      id,trt_placebo,age,sex_f,ascites_1,hepato_1,...[18]       trt_placebo
#> 5:      id,trt_placebo,age,sex_f,ascites_1,hepato_1,...[19]          alk.phos
```
