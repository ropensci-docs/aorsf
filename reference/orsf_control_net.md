...
[orsf](https://docs.ropensci.org/aorsf/reference/orsf.md) model.
...
[orsf](https://docs.ropensci.org/aorsf/reference/orsf.md) that indicates
the number of variables chosen at random prior to finding a linear
