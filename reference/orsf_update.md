...
- ...:
  ...
  [orsf](https://docs.ropensci.org/aorsf/reference/orsf.md) that will be
  used to define the update. These arguments include:
...
- no_fit:
  ...
  submitted to
  [`orsf_train()`](https://docs.ropensci.org/aorsf/reference/orsf.md) so
  long as `attach_data` is `TRUE`.
