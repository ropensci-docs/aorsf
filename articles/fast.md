...
[`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) is `NULL`
because, if unspecified,
[`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) will pick
...
[`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) needs to
...
[`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) that can
...
[`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) run
...
time_est
#> Time difference of 189.1622 secs
```
