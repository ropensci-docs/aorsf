...
- [`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) no
  ...
  [`?orsf`](https://docs.ropensci.org/aorsf/reference/orsf.md) that
  explains why using a single predictor with
  [`orsf()`](https://docs.ropensci.org/aorsf/reference/orsf.md) is
